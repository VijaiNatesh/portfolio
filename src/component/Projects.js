...
function Projects() {
    return (
        ...
        <div className ={styles.projectDisplay}>          
            ...
            <a className ={styles.projectLink}href = "https://inventoryvijainatesh.netlify.app/" target = "_blank" rel="noreferrer">Visit</a></h2>
            <p className ={styles.projectDes}>Inventory Bill App is a <b> free billing app</b>.
                                            ...
                                            <br/> It was developed with <b>MongoDB, Express, React and Node</b>.
        ...
        <div className ={styles.projectDisplay}>          
            <h2 className ={styles.projectTitle}>Student Mentor Assigning <br/>
            <a className ={styles.projectLink}href = "https://assign-mentor-vj.netlify.app/" target = "_blank" rel="noreferrer">Visit</a></h2>
        ...
        <div className ={styles.projectDisplay}>          
            ...
            <a className ={styles.projectLink}href = "https://password-reset-vj.netlify.app/" target = "_blank" rel="noreferrer">Visit</a></h2>
